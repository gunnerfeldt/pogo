...
function keyboard(keys) {
    ...
    //   canvas.style.width = (pWidth * 8) + "px";
    var ctx = canvas.getContext("2d");
    ctx.scale(1, -1);
    ctx.translate(0, -keyHeight);
    var keyMap = [0, 1, 2, 0, 1, 1, 2];
...
drawKey[0] = function(ctx, key) {
    ctx.strokeStyle = colors[7]
    ctx.beginPath();
    ctx.moveTo(0, 0);
    ctx.lineTo(0, keyHeight);
    ctx.lineTo(keyWidth * 0.66, keyHeight);
    ctx.lineTo(keyWidth * 0.66, keyHeight * blackKey);
    ctx.lineTo(keyWidth, keyHeight * blackKey);
    ctx.lineTo(keyWidth, 0);
    ctx.lineTo(0, 0);
...
drawKey[1] = function(ctx, key) {
    ctx.strokeStyle = colors[7]
    ctx.beginPath();
    ctx.moveTo(0, 0);
    ctx.lineTo(0, keyHeight * blackKey);
    ctx.lineTo(keyWidth * 0.33, keyHeight * blackKey);
    ctx.lineTo(keyWidth * 0.33, keyHeight);
    ctx.lineTo(keyWidth * 0.66, keyHeight);
    ctx.lineTo(keyWidth * 0.66, keyHeight * blackKey);
    ctx.lineTo(keyWidth, keyHeight * blackKey);
    ctx.lineTo(keyWidth, 0);
